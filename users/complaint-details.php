...
<html lang="en">
  <head>
    ...
    <title>CMS | Detail Komplain</title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content" style="padding-left:5%; color:#000">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Detail Komplain</h3>
            <hr />
...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Nomor Tiket : </b></label>
          		<div class="col-sm-4">
          		<p><?php echo htmlentities($row['complaintNumber']);?></p>
          		</div>
<label class="col-sm-2 col-sm-2 control-label"><b>Tanggal Pengajuan :</b></label>
              <div class="col-sm-4">
...
<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Kategori :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['catname']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Sub Kategori :</b> </label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Tipe Komplain :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['complaintType']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Unit Kerja :</b></label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Judul :</b></label>
              <div class="col-sm-4">
...
<a href="complaintdocs/<?php echo htmlentities($row['complaintFile']);?>" target='_blank'>Lihat Dokumen/Gambar</a>
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Detail/Deskripsi Komplain </label>
              <div class="col-sm-10">
