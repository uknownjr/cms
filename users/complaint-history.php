...
<html lang="en">
  <head>
    ...
    <title>CMS | Riwayat Permasalahan</title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Riwayat Permasalahan</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr style="text-align: center">
                                  ...
                                  <th style="text-align: center">Tanggal Terakhir diupdate</th>
                              ...
                              <tr>
                                 ...
                                 ?></td>
                                  <td align="center"><?php 
                                    ...
                                    { ?>
                                      <button type="button" class="btn btn-theme04">Belum diproses</button>
                                   <?php }
...
<button type="button" class="btn btn-primary">Lihat Detail</button></a>
                                   </td>
                                </tr>
                              <?php } ?>
